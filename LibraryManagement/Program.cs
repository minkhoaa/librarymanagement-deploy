...
var envDirectories = new[] { AppContext.BaseDirectory, Directory.GetCurrentDirectory() };
var visitedDirectories = new HashSet<string>(StringComparer.OrdinalIgnoreCase);
var envLoaded = false;

foreach (var directory in envDirectories)
{
...
if (string.IsNullOrWhiteSpace(emailConfig.SmtpServer) ||
    ...
    string.IsNullOrWhiteSpace(emailConfig.SenderEmail) ||
    string.IsNullOrWhiteSpace(emailConfig.SenderPassword))
{
    throw new InvalidOperationException("EmailSettings configuration is invalid or incomplete");
}
...
builder.Services.AddFluentEmail(emailConfig.SenderEmail, "Library Management")
