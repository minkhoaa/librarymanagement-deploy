-- Xoá các bảng cũ (nếu có) để import lại cho sạch
...
-- Seed default TypeReader for registration flow
...
(
    ...
    BIOGRAPHY TEXT,
    CONSTRAINT FK_AUTHOR_TYPEBOOK FOREIGN KEY (ID_TYPEBOOK) REFERENCES TYPEBOOK(ID_TYPEBOOK) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT FK_CREATE_AUTHOR FOREIGN KEY (ID_AUTHOR) REFERENCES AUTHOR(ID_AUTHOR) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT FK_IMG_AUTHOR FOREIGN KEY (ID_AUTHOR) REFERENCES AUTHOR(ID_AUTHOR) ON DELETE CASCADE
);
